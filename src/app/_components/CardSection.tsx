  ...
  return (
   <section className="space-y-24">
    ...
    <div className=" space-y-4  font-poppins">
        ...
        <p className="text-sm text-muted-foreground max-w-xl mx-auto text-center">Lorem ipsum dolor sit amet consectetur. Dui lacus purus commodo lacus amet et. Pulvinar etiam sit nec nunc massa cursus. </p>
    </div>
   </section>
  );
};
