...
const Collobarators = () => {
  return (
    <div className="flex flex-col items-center justify-center gap-2.5 font-poppins bg-white sm:container max-w-screen-3xl mx-auto">
      ...
      <p className="w-2/4 text-center text-sm">Lorem ipsum dolor sit amet consectetur. Dui lacus purus commodo lacus amet et. Pulvinar etiam sit nec nunc massa cursus.</p>
